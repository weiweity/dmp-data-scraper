...
## 7. Sprint 5 6 个专有工单 (Sprint 5 backlog, 5+1 重编号 #20-#25)

| # | 工单 | 优先级 | 状态 | 依赖 |
|---|---|---|---|---|
| **#20** | 主项目 scraper/ 软**删** + symlink (修正错报) | P0 | pending (Sprint 5 第 2 工单) | 独立 |
| **#21** | 独立 repo 双层 scraper/ 清**理** (`/scraper/core/` 跟 `/core/` 选一, **删内层**) | P1 | pending (Sprint 5 第 3 工单) | 依赖 #25 |
| **#22** | 5 行修 dmp_master.py:678 重建 + commit (等用户提供 5 行内容) | P2 | pending (Sprint 5 第 4 工单) | 用户 |
| **#23** | 简历文档 `dmp-data-scraper.md` 跟新 (路径 → 独立 repo) | P1 | pending (Sprint 5 第 5 工单) | 独立 |
| **#24** | SCRAPER-4-PLAN.md 创**建** (Sprint 4 改名记录) | P0 | ✅ completed (v0.4.14.42) | — |
| **#25** | **Sprint 19+ #141 修复同步到外层** (Sprint 5 启动前新发现, 生产 `core/dmp_common.py` 无修复, 业务码失效不重登) | **P0 紧急** | pending (Sprint 5 第 1 工单) | 独立 |

> 详细见 `docs/SCRAPER-5-PLAN.md` (5+1 工单 + 依赖 + 风险)
...
| 变更日志 | `CHANGELOG.md` | v0.4.14.39/40/41/42/43/44 完整记录 |
...
| **Sprint 4 计划** | `docs/SCRAPER-4-PLAN.md` | Sprint 4 5 工单历史记录 (Task #15-#19) |
| **Sprint 4 复盘** | `docs/SCRAPER-4-RETROSPECTIVE.md` | Sprint 16.5+1 + 19+ 收口 |
| **Sprint 5 计划** | `docs/SCRAPER-5-PLAN.md` | Sprint 5 6 工单 #20-#25 (含 #25 紧急新发现) |
| **Sprint 5 复盘** | `docs/SCRAPER-5-RETROSPECTIVE.md` | Sprint 5 收口 (待填) |
